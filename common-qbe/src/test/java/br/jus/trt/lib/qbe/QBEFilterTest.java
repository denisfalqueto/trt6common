...
public class QBEFilterTest extends QbeTestBase {
	...
	public void consultaEntidadeFiltroPropAninhado() {
		...
		List<Cidade> cidadesHQL = searchAndValidateNotEmpty(hql, exemplo.getUf().getSigla());		
	...
	public void consultaEntidadeFiltroPropRepeticaoAlias() {
		...
		List<Cidade> cidadesHQL = searchAndValidateNotEmpty(hql, "PE", "PB");		
	...
	public void consultaPolimorficoTipoExemplo() {
		...
		servidor1.setCidade(findAt(Cidade.class, 0));
		...
		servidor2.setCidade(findAt(Cidade.class, 0));
