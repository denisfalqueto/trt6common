...
public class ContainerTest extends QbeTestBase {
	...
	public void testContainerDefaultAND() {
		...
		List<Pessoa> hqlLista = searchAndValidateNotEmpty(hql, p2.getNome(), p2.getCpf());
	...
	public void testContainerDefaultOR() {
		...
		List<Pessoa> hqlLista = searchAndValidateNotEmpty(hql, p2.getNome(), p2.getCpf(), p2.getEmail());
	...
	public void testContainerOR() {
		...
		List<Pessoa> hqlLista = searchAndValidateNotEmpty(hql, p2.getEmail(), p2.getNome(), p2.getCpf());
	...
	public void testContainerNegacao() {
		...
		List<Pessoa> hqlLista = searchAndValidateNotEmpty(hql, p1.getCpf(), p3.getEmail());
	...
	public void testContainerAND() {
		...
		List<Pessoa> hqlLista = searchAndValidateNotEmpty(hql, p2.getCpf(), p2.getNome(), p2.getEmail());
	...
	public void testContainerDuploAND_OR() {
		...
		List<Pessoa> hqlLista = searchAndValidateNotEmpty(hql, p2.getCpf(), p2.getEmail(), p1.getNome(), p2.getEmail());
	...
	public void testContainerDuploOR_AND() {
		...
		List<Pessoa> hqlLista = searchAndValidateNotEmpty(hql, p2.getCpf(), p1.getNome(), p2.getCpf(), p1.getEmail());
	...
	public void testContainerAninhadoOR_AND() throws ParseException {
		...
		List<Pessoa> hqlLista = searchAndValidateNotEmpty(hql, p2.getEmail(), p1.getCpf(), p1.getDataNascimento());
	...
	public void testContainerXOR2Operacoes() throws ParseException {
		...
		List<Pessoa> hqlLista = searchAndValidateNotEmpty(hql, p1.getNome(), p2.getCpf(), p1.getNome(), p2.getCpf());		
	...
	public void testContainerXOR3Operacoes() throws ParseException {
		...
		List<Pessoa> hqlLista = searchAndValidateNotEmpty(hql, nome, cpf, cpf, nome, cpf, nome); // p1, p3		
