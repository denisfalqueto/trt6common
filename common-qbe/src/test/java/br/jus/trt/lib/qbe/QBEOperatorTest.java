...
public class QBEOperatorTest extends QbeTestBase {
	...
	public void consultarEntidadeOperadorDefault() {
		...
		Cidade cidadeBD = findAny(Cidade.class);
		...
		List<Cidade> cidadesHQL = searchAndValidateNotEmpty(hql, exemplo.getNome());		
	...
	public void consultarOperadorNotEqual() {
		...
		List<UF> ufHQL = searchAndValidateNotEmpty(hql, exemplo.getSigla());		
